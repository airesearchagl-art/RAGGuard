...
RULES: tuple[Rule, ...] = (
    ...
    Rule(
        ...
        "contract_info",
        "FAIL",
        re.compile(r"(?:支払条件|月末締め|翌月末払い|着手金|手付|出来高払い|精算条件|追加業務費)"),
        DEFAULT_RECOMMENDATION,
        "keyword",
    ),
    Rule(
        ...
        "contract_info",
        "FAIL",
        re.compile(r"(?:契約条件|特約|解約条項|違約金|秘密保持|NDA|優先交渉|専属専任|責任範囲|契約交渉|免責|約款)"),
        DEFAULT_RECOMMENDATION,
        "keyword",
    ),
    Rule(
        ...
        "internal_info",
        "FAIL",
        re.compile(r"(?:社内限り|内部資料|非公開|未公開|未公表|稟議|決裁|承認前|ドラフト|取扱注意|紛争|クレーム|内部評価|経営判断)"),
        DEFAULT_RECOMMENDATION,
        "keyword",
    ),
    Rule(
